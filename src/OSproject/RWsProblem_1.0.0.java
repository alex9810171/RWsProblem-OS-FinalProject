...
public class RWsProblem {
	...
	public static int red_count = 0;
	public static int blue_count = 0;
	
	public static int red_finish = 0;
	public static int blue_finish = 0;
	...
	public static int speedControl = 1;	
	...
	public static Object redFinish = new Object();
	public static Object blueFinish = new Object();
    ...
    public static class DrawRoom implements Runnable {
    	...
    	public void paint(Graphics2D g) {
    		  ...
    		  g.setFont(new Font("TimesRoman", Font.PLAIN, 25)); 
	   		  ...
	   		  g.drawString("Generated Writers:"+blue_count, 575, 590);
    		
   	   		  g.setPaint(Color.RED);
	   		  g.drawString("Waiting Readers: "+wwaitCount, 575, 500);
	   		  g.drawString("Generated Readers: "+red_count, 575, 560);
    ...
    public static class BallWithOwnThread implements Runnable {
        ...
        public void run() {
                ...
                if(color == Color.BLUE) {
           		...
           		synchronized(redFinish) {
            		synchronized(blueFinish) {
		           		  blue_finish++;
		             	 if(red_finish == red_size && blue_finish == blue_size) {
